        ...
        <div class="d-flex flex-wrap align-items-stretch">
            <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                <div class="p-4 m-3">
                    ...
                    <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">SMKN 2</span></h4>
                    <p class="text-muted">Before you get started, you must login or register if you don't already have an
                        account.
                    </p>
                    @if ($message = Session::get('failed'))
                        <div class="alert alert-danger justify-content-center w-100 mb-4 mr-auto ml-auto text-center"
                            role="alert">
                            {{ $message }}
                        </div>
                    @endif
                    <form method="POST" action="/loginCheck" method="POST">
                        @csrf
                        ...
                        <div class="form-group text-right">
                            <a href="/addReg" class="float-left mt-3">
                                Forgot Password?
                            </a>
